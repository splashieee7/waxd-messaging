...
import com.waxd.messaging.datamodel.BoundCursorLoader;
...
import com.waxd.messaging.datamodel.binding.BindableData;
import com.waxd.messaging.datamodel.binding.Binding;
import com.waxd.messaging.datamodel.binding.BindingBase;
import com.waxd.messaging.datamodel.data.SubscriptionListData.SubscriptionListEntry;
import com.waxd.messaging.sms.MmsSmsUtils;
import com.waxd.messaging.sms.MmsUtils;
import com.waxd.messaging.util.Assert;
import com.waxd.messaging.util.Assert.RunsOnMainThread;
...
public class ConversationData extends BindableData {
     ...
     */
    private class MetadataLoaderCallbacks extends CursorLoaderCallbacks {
        @Override
     ...
     * A trampoline class so that we can inherit from LoaderManager.LoaderCallbacks multiple times.
     */
    private class MessagesLoaderCallbacks extends CursorLoaderCallbacks {
        @Override
        public Loader<Cursor> onCreateLoader(final int id, final Bundle args) {
        ...
        @Override
        public void onLoadFinish(final Loader<Cursor> generic, final Cursor rawData) {
            final BoundCursorLoader loader = (BoundCursorLoader) generic;
     ...
     * A trampoline class so that we can inherit from LoaderManager.LoaderCallbacks multiple times.
     */
    private class ParticipantLoaderCallbacks extends CursorLoaderCallbacks {
        @Override
        public Loader<Cursor> onCreateLoader(final int id, final Bundle args) {
     ...
     * A trampoline class so that we can inherit from LoaderManager.LoaderCallbacks multiple times.
     */
    private class SelfParticipantLoaderCallbacks extends CursorLoaderCallbacks {
        @Override
        public Loader<Cursor> onCreateLoader(final int id, final Bundle args) {
    ...
    /**
     * Returns {@link com.waxd.messaging.datamodel.data.SubscriptionListData
