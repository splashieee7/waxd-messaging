 ...
 */
package com.waxd.messaging.datamodel.media;
...
import com.waxd.messaging.datamodel.media.PoolableImageCache.ReusableImageResourcePool;
        ...
        if (mCanUseThumbnail) {
            ...
            if (thumbnail != null) {
                ...
                try {
                    ...
                    if (com.waxd.messaging.util.exif.ExifInterface.
